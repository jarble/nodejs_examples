...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar101 = (f);
			int __temp_hash103 = __temp_svar101.hashCode();
			boolean __temp_executeDef102 = true;
			switch (__temp_hash103)
			{
				case -1106363674:
				{
					if (__temp_svar101.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash103 == 530542161 ) && __temp_svar101.equals("substring") )) || ( (( ( __temp_hash103 == -891529231 ) && __temp_svar101.equals("substr") )) || ( (( ( __temp_hash103 == 109648666 ) && __temp_svar101.equals("split") )) || ( (( ( __temp_hash103 == -467511597 ) && __temp_svar101.equals("lastIndexOf") )) || ( (( ( __temp_hash103 == 1943291465 ) && __temp_svar101.equals("indexOf") )) || ( (( ( __temp_hash103 == 397153782 ) && __temp_svar101.equals("charCodeAt") )) || ( (( ( __temp_hash103 == -1361633751 ) && __temp_svar101.equals("charAt") )) || ( (( ( __temp_hash103 == -1137582698 ) && __temp_svar101.equals("toLowerCase") )) || __temp_svar101.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef102 = false;
